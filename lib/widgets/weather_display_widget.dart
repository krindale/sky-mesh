...
// 위젯 imports
import 'weather_condition_card_widget.dart'; // 컨디션 카드 위젯
import 'weather_condition_tags_widget.dart'; // 컨디션 태그 위젯

// 디자인 시스템 imports
import '../design_system/design_system.dart'; // 디자인 시스템
...
class WeatherDisplayWidget extends StatefulWidget {
  ...
  /// 날씨 컨디션 카드 목록 (null일 경우 Today's Briefing 섹션 숨김)
  final List<WeatherConditionCard>? conditionCards;
...
class _WeatherDisplayWidgetState extends State<WeatherDisplayWidget>
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: [
                    ...
                    children: [
                      ...
                      Expanded(
                        child: SingleChildScrollView(
                          ...
                          physics:
                              const BouncingScrollPhysics(), // iOS 스타일 바운싱 효과
                  ...
                  // === 우상단 버튼들 (Today's Briefing + 새로고침) ===

                  /// 우상단에 고정된 버튼들
                  /// Today's Briefing과 새로고침 버튼을 세로로 배치
                  Positioned(
                    top: 16, // 상단에서 16px
                    right: 16, // 우측에서 16px
                    child: Column(
                      children: [
                        // Today's Briefing 버튼
                        if (widget.conditionCards != null &&
                            widget.conditionCards!.isNotEmpty)
                          _buildTodaysBriefingButton(context),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          /// Weather condition tags 표시
          /// 도시 이름 위에 현재 날씨 상태 태그들을 표시
          if (widget.conditionCards != null &&
              widget.conditionCards!.isNotEmpty)
            WeatherConditionTagsWidget(
              cards: widget.conditionCards!,
              onTagTap: (card) {
                WeatherConditionCardDetailDialog.show(context, card);
              },
            ),
          ...
          SizedBox(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                final forecast =
                    widget.hourlyWeatherData!.hourlyForecasts[index];
        ...
        children: [
          ...
          SizedBox(
            ...
            child: Text(
              ...
              style: TextStyle(
                color: forecast.isToday
                    ? Colors.white
                    : Colors.white.withValues(alpha: 0.8),
                fontSize: 14,
                fontWeight: forecast.isToday
                    ? FontWeight.w600
                    : FontWeight.w500,
              ),
            ),
  ...
  String _getShortWeatherDescription(String description) {
    ...
    if (lowerDesc.contains('scattered') || lowerDesc.contains('broken'))
      return '흐림';
          ...
          Center(
            child: Row(
              ...
              children: [
                ...
                Text(
                  _getUVIndexDescription(widget.weatherData!.uvIndex?.round()),
                  style: TextStyle(
                    color: Colors.white.withValues(alpha: 0.8),
                    fontSize: 14,
                    fontWeight: FontWeight.w400,
  ...
  String _getUVIndexDescription(int? uvIndex) {
    if (uvIndex == null) return '-'; // Not available
    // WHO 기준 UV 지수 단계별 분류
  ...
  /// Today's Briefing 버튼 구성 메서드
  ///
  /// 우상단에 표시되는 Today's Briefing 바텀시트 오픈 버튼을 생성합니다.
  Widget _buildTodaysBriefingButton(BuildContext context) {
    return Container(
      width: 48,
      height: 48,
      decoration: BoxDecoration(
      ...
      child: Material(
        ...
        child: InkWell(
          borderRadius: BorderRadius.circular(24),
          onTap: () => _showTodaysBriefingBottomSheet(context),
          child: Icon(
  ...
  /// Today's Briefing 바텀시트 표시 메서드
  ///
  /// 하단에서 올라오는 모달 바텀시트로 날씨 컨디션 카드들을 표시합니다.
  void _showTodaysBriefingBottomSheet(BuildContext context) {
    if (widget.conditionCards == null || widget.conditionCards!.isEmpty) {
      return;
    }
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                height: 4,
                decoration: BoxDecoration(
                  color: LowPolyColors.textSecondary.withValues(alpha: 0.3),
              ...
              // 컨디션 카드 목록
              Expanded(
                child: WeatherConditionCardsWidget(
                  cards: widget.conditionCards!,
                  onCardTap: (card) {
                    WeatherConditionCardDetailDialog.show(context, card);
                  },
